...
@Disabled
public class SensorRedCarouselWarehouse extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory toDetect = drive.trajectoryBuilder(toCarouselSpinner.end())
                .lineToLinearHeading(new Pose2d(0.743, 20.186, 1.571))
                .build();
        ...
        Trajectory toShippingHub2 = drive.trajectoryBuilder(toShippingHub.end())
                .lineToLinearHeading(new Pose2d(23.924, 22.819 + yOffset, 1.427))
                .build();

        Trajectory toPark = drive.trajectoryBuilder(toShippingHub2.end())
                .lineToLinearHeading(new Pose2d(37.166, -0.75, 6.0))
                .build();

        Trajectory toPark2 = drive.trajectoryBuilder(toPark.end())
                .lineToLinearHeading(new Pose2d(79.726, -0.75, 6.0))
                .build();
